...
namespace bie
{
    ...
    template <int dim>
    class Point : public BoundaryElement
    {
    public:
        ...
        virtual il::Array<double> ConvertToGlobal(const il::Array<double> &x) const override
        {
            return x;
        }
        virtual il::Array<double> ConvertToLocal(const il::Array<double> &x) const override
        {
            return x;
        }
    ...
    template <int dim>
    inline void Point<dim>::SetNodes()
    {
        this->nodes_ = this->collocation_points_;
    }

    template <int dim>
    inline void Point<dim>::SetCollocationPoints()
    {
        this->collocation_points_ = this->vertices_;
    }

    template <int dim>
    inline void Point<dim>::SetRotationMatrices()
    {
