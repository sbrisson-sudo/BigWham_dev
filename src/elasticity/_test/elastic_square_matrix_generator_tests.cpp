...
TEST(SquareMatGen, segment_0_1) {
  ...
  bie::SquareMatrixGenerator<
      double, bie::Segment<0>,
      bie::BieElastostatic<bie::Segment<0>, bie::Segment<0>,
                           bie::ElasticKernelType::H>>
      M(my_mesh, test, permutation);
...
TEST(SquareMatGen, segment_0_2) {
  ...
  ASSERT_TRUE(M.blockSize() == 2 &&
              M.sizeAsBlocks(0) == my_mesh.numberOfElts());
}
...
TEST(SquareMatGen, segment_0_Hmat_1) {
  ...
  bie::SquareMatrixGenerator<
      ...
      bie::BieElastostatic<bie::Segment<0>, bie::Segment<0>,
                           bie::ElasticKernelType::H>>
      M(my_mesh, ker, hr.permutation_0_);
...
TEST(SquareMatGen, segment_0_Hmat_2) {
  ...
  bie::SquareMatrixGenerator<
      double, el_type,
      bie::BieElastostatic<el_type, el_type, bie::ElasticKernelType::H>>
      M(my_mesh, ker, hr.permutation_0_);
...
TEST(SquareMatGen, segment_1_Hmat_1_segs_45_a1) {
  ...
  bie::BieElastostatic<bie::Segment<1>, bie::Segment<1>,
                       bie::ElasticKernelType::H>
      ker(elas, xy.size(1));
...
TEST(SquareMatGen, Triangle_0_1) {
  ...
  il::Array2D<double> xcol = my_mesh.getCollocationPoints();
  bie::ElasticProperties elas(1, 0.0);
  bie::BieElastostatic<El_type, El_type, bie::ElasticKernelType::H> ker(
      elas, coor.size(1));
  il::Array<double> prop{1, 1000.};
  ker.setKernelProperties(prop);
  il::int_t max_leaf_size = 32;
