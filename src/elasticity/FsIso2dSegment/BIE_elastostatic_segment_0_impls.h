...
namespace bie {
    ...
    BieElastostatic<Segment<0>, Segment<0>, U>::influence(Segment<0> source_elt, il::int_t i_s, Segment<0> receiver_elt, il::int_t i_r) const {
...
//       Singular Kernel   T
    template<>
    inline std::vector<double>
    BieElastostatic<Segment<0>, Segment<0>, T>::influence(Segment<0> source_elt, il::int_t i_s, Segment<0> receiver_elt, il::int_t i_r) const {
        ...
        il::StaticArray2D<double, 2, 3> stress_l = Se_segment_0(h, this->elas_.getG(), this->elas_.getNu(), xe[0], xe[1]);
...
//St(1, 1)
    ...
    template<>
    inline std::vector<double>
    BieElastostatic<Segment<0>, Segment<0>, H>::influence(Segment<0> source_elt, il::int_t i_s, Segment<0> receiver_elt, il::int_t i_r) const {
