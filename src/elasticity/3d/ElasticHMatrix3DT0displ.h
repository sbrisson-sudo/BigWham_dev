...
#ifndef BIGWHAM_ELASTICHMATRIX3DT0DISPL_H
...
namespace bie {
    ...
    template <typename T>
    class ElasticHMatrix3DT0displ : public bie::MatrixGenerator<T> {
    private:
    ...
    public:
        ...
        ElasticHMatrix3DT0displ(il::Array2D<double> &point, const il::Array<il::int_t> &permutation,
    ...
    template <typename T>
    ElasticHMatrix3DT0displ<T>::ElasticHMatrix3DT0displ(il::Array2D<double> &point, const il::Array<il::int_t> &permutation,
    ...
    template <typename T>
    il::int_t ElasticHMatrix3DT0displ<T>::size(il::int_t d) const {
    ...
    template <typename T>
    il::int_t ElasticHMatrix3DT0displ<T>::blockSize() const {
    ...
    template <typename T>
    void ElasticHMatrix3DT0displ<T>::set(il::int_t b0,il::int_t b1,il::io_t,il::Array2DEdit<T> M) const
    {
        /*  Preliminaries:
...
#pragma omp for
            for (il::int_t j1 = 0; j1 < M.size(1) / blockSize();
                ...
                for (il::int_t j0 = 0; j0 < M.size(0) / blockSize(); ++j0) {
                    ...
                    stnl = bie::displacement_influence_3DT0(
