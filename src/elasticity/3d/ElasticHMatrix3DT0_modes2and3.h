...
namespace bie {
    ...
    template <typename T>
    class ElasticHMatrix3DT0_modes2and3 : public bie::MatrixGenerator<T> {
    private:
    ...
    public:
        ...
        ElasticHMatrix3DT0_modes2and3(il::Array2D<double> &point, const il::Array<il::int_t> &permutation,
    ...
    template <typename T>
    ElasticHMatrix3DT0_modes2and3<T>::ElasticHMatrix3DT0_modes2and3(il::Array2D<double> &point, const il::Array<il::int_t> &permutation,
    ...
    template <typename T>
    il::int_t ElasticHMatrix3DT0_modes2and3<T>::size(il::int_t d) const {
    ...
    template <typename T>
    il::int_t ElasticHMatrix3DT0_modes2and3<T>::blockSize() const {
        return 2;  // # of degree of freedom per node
    }

    template <typename T>
    il::int_t ElasticHMatrix3DT0_modes2and3<T>::sizeAsBlocks(il::int_t d) const {
        IL_EXPECT_MEDIUM(d == 0 || d == 1);
    ...
    template <typename T>
    void ElasticHMatrix3DT0_modes2and3<T>::set(il::int_t b0,
                                    il::int_t b1,
                                    il::io_t,
