...
template <typename T> void Hmat<T>::matvecOriginal(const il::ArrayView<T> x, il::ArrayEdit<T> yout) {
...
/* -------------------------------------------------------------------------- */
// H-Matrix vector multiplication with permutation for rectangular matrix
template <typename T> void Hmat<T>::matvecOriginal(const il::ArrayView<T> x, il::Array<T>& yout) {
