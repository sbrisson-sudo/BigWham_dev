...
public :
    ...
    */
    ...
    void copyArray2DVectorContent(const std::vector<std::unique_ptr<il::Array2D<T>>>& source_blocks){
        ...
        for (const auto& block : source_blocks) {
            ...
            size_t aligned_block_size = align_to_cache_line(block_size * sizeof(T)) / sizeof(T);
