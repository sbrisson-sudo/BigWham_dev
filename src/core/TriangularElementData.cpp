...
#include "TriangularElementData.h"
...
namespace bie {
    ...
    TriangularElementData::TriangularElementData(il::StaticArray2D<double, 3, 3> xv, il::int_t p) {
        ...
        vec02[0] = xv(2, 0) - xv(0, 0);
        vec02[1] = xv(2, 1) - xv(0, 1);
        vec02[2] = xv(2, 2) - xv(0, 2);
    ...
    il::Array2D<double> TriangularElementData::getNodes() { // get nodes' coordinates
        return nodes_;
    }

    il::Array2D<double> TriangularElementData::getCollocationPoints() { // get collocation points' coordinates
        return collocation_points_;
    }

    il::StaticArray2D<double, 3, 3> TriangularElementData::getVertices() { // get vertices' coordinates
        return vertices_;
    }

    const double TriangularElementData::getBeta1() {
        return beta1_;
    }

    const double TriangularElementData::getBeta2() {
        return beta2_;
    }
    ...
    il::Array2D<double> TriangularElementData::computeNodes() {
        // inputs
    ...
    il::Array2D<double> TriangularElementData::computeCollocationPoints() {
        // inputs
        //   -none; it requires the previous construction of an object of the class and then
        //   uses its member variables implicitly
        // output
    ...
    il::StaticArray2D<double, 3, 3> TriangularElementData::rotationMatrix(){
        // inputs
        //   -none; it requires the previous construction of an object of the class and then
        //   uses its member variables implicitly
        // output
