...
class BEMesh {
private:
  E element_def_; // element_def_ is an instance of the element type of the
                  // mesh.  Could be extended to an array of element ?
...
public:
  ...
  // element type !
  BEMesh(il::Array2D<double> &Coordinates,
